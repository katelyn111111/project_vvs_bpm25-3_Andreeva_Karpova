...
class Cosinus(Scene):
    def construct(self):
        ...
        axes = Axes(
            ...
            x_length=14,
            y_length=10,
            axis_config={"color": BLACK, "stroke_color": BLACK, 'decimal_number_config' : {"color": rgb_to_color([1,1,1])}},  # цвет системы координат
            ...
            x_axis_config={
                ...
                'font_size': 24,
                'color': BLACK  # Черный цвет для цифр на оси X
            },
            y_axis_config={
                'numbers_to_include': np.arange(-6, 6, 1),
                'numbers_with_elongated_ticks': np.arange(-6, 6, 1),
                'font_size': 24,
                'color': BLACK  # Черный цвет для цифр на оси Y
            },
            tips=False
        )

        # Также задаем черный цвет для меток осей
        ...
        axes_zoom = Axes(
            ...
            x_axis_config={
                ...
                'font_size': 24,
                'color': BLACK  # Черный цвет для цифр на оси X при увеличении
            },
            y_axis_config={
                'numbers_to_include': np.arange(-2, 2, 0.5),
                'numbers_with_elongated_ticks': np.arange(-2, 2, 1),
                'font_size': 24,
                'color': BLACK  # Черный цвет для цифр на оси Y при увеличении
            },
            tips=False
        )
